...
public class MainEstatica {
	public static void main(String[] args) {
		...
		MatrizEstatica m = new MatrizEstatica(4000, 2000);
		m.preencherMatriz();

		MatrizEstatica m2 = new MatrizEstatica(2000, 4000);
		m2.preencherMatriz();
		...
		System.out.println();
		System.out.println("terminou as " + Relogio.Passou(inicio));
		//	bla.imprimirMatriz();


//		MatrizEstatica m10 = new MatrizEstatica(5, 3);
//		m10.preencherMatriz();
//		m10.imprimirMatriz();
